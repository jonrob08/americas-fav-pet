...
<template>
 <div class="navbar relative dark:bg-slate-800">
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-between md:space-x-10">
          ...
          <nuxt-link to="/">
            ...
            <img class="h-16 md:h-24 w-3/4 transition duration-500 scale-50 md:hover:scale-110"
              src="../../assets/img/logo-h.svg" />
          </nuxt-link>
          <div class="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <nuxt-link to="/support" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900"> Support
            </nuxt-link>
            <nuxt-link v-if="!user" to="/login"
                       class="whitespace-nowrap text-base  ml-8 font-medium text-gray-500 hover:text-gray-900"> Sign
              in
            </nuxt-link>
